...
public class Controller implements ActionListener, ItemListener {
	...
	public Controller() {
		...
		crud1 = new CrudBinario(archivo1);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "BtnIniciarSesion":
			String usuario = main.getVen().getbtnUsuario().getText();
		    ...
		    if (usuario.equals(usuarioPredeterminado) && contraseña.equals(contraseñaPredeterminada)) {
	...
	public void itemStateChanged(ItemEvent e) {
	    if (e.getSource() == main.getEstadisticas().getOpciones()) {
	        if (e.getStateChange() == ItemEvent.SELECTED) {
	            String selectedOption = (String) main.getEstadisticas().getOpciones().getSelectedItem();
		            ...
		            if (selectedOption.equals("Informacion completa facultad de ingenieria")) {
		                ...
		                String usuario = JOptionPane.showInputDialog(null, "Ingrese el nombre de usuario del estudiante a dar de baja:");
		                
		                if (usuario != null) { // Verificar si se ingresó un nombre de usuario válido
		                    boolean eliminado = crud1.eliminarEstudiante(usuario, null);
